...
def show_solution(Vh, ic, state, same_colorbar=True, colorbar=True, mytitle=None, 
    ...
    for i in times:
        ...
        # it will forever be a mystery why I had to add the int() here. For some reason it was a float.
        plot(myu, subplot_loc=(int(subplot_loc+counter)), mytitle=title_stamp.format(i), colorbar=colorbar, 
