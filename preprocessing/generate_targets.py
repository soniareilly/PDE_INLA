...
filename_2d = (REPO_ROOT/"targets/targets_2d.txt")
np.savetxt(filename_2d, targets_2d_array, fmt='%.6f', header='x y')
...
filename_3d = (REPO_ROOT/"targets/targets_3d.txt")
np.savetxt(filename_3d, targets_3d_array, fmt='%.6f', header='x y z')
